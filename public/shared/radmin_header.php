                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="managementDropdownMenu">
                            <li><a class="dropdown-item" href="/reserba/public/radmin/manage-restaurant.php">Manage Restaurant</a></li>
                            <li><a class="dropdown-item" href="/reserba/public/radmin/manage-reservations.php">Manage Reservations</a></li>
                          </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="accountDropdownMenuLink">
                              <li><a class="dropdown-item" href="/reserba/public/radmin/radmin_profile.php">My Account</a></li>
